...
<div class="wrapper">
    ...
    <header class="main-header">
        <a class="logo">
            ...
            <span class="logo-lg"><b>W</b>kd</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu" style="background: none;">
                        <a class="dropdown-toggle">
                            <img src="http://admin.onepieces.cn/images/profile_small.jpg" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="http://admin.onepieces.com/images/profile_small.jpg" class="img-circle" alt="User Image">
                </div>
