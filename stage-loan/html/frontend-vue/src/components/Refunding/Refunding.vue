<template>
  <div class="refunding">
    <refunding-title>您的还款申请已提交，后台处理中</refunding-title>
    <div class="refunding-content">
    ...
    <div class="refunding-footer">
      <x-button class="btn-tip" plain type="primary" action-type="button">还款中</x-button>
    </div>
  </div>
</template>

<script>
import RefundingTitle from '@/components/HomeContentTitle/HomeContentTitle'
