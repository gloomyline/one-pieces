    ...
    <div style="overflow: auto">
        ...
        <el-form :model="form" :rules="rules" ref="articleForm" label-width="120px" style="width:1220px;">
            ...
            <el-form-item label="审核意见">
                <el-input type="textarea" v-model="form.opinion"  :rows="2" placeholder="请输入意见内容"  style="width:500px;" :maxlength="200"></el-input>
            </el-form-item>
            <el-form-item>
                <el-button type="primary" @click.native="handleSubmit">提交审核</el-button>
    ...
    methods: {
      ...
      handleSubmit() {
        ...
        const params = {
          ...
          on_sale: this.form.on_sale,
          opinion: this.form.opinion,
        };
        this.$http.put(`${apiBase}pro-audit/${this.product_id}`, params)
          .then(getJsonAndCheckSuccess)
          .then(() => {
            this.$message({
              type: 'success',
