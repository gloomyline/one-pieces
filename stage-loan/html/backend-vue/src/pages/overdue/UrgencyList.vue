<template>
  <div>
    ...
    <el-table :data="tableData" stripe border style="width: 100%;">
      ...
      <el-table-column property="mobile" label="手机号" align="center" min-width="130"></el-table-column>
	  ...
	  <el-table-column property="created_at" label="分配时间" align="center" width="180"></el-table-column>
      ...
      <el-table-column label="操作" align="center"  width="150">
        <template slot-scope="scope">
          <el-button-group style="">
            <el-button type="primary" size="small"  @click.native="showFormDialog(scope.row.id, scope.row.urge_count, scope.row.budget_plan_id)" v-if="scope.row.state != 4 && scope.row.state != 3">催收</el-button>
      ...
      <el-form :model="urgeForm" labelWidth="150px" labelPosition="left">
        ...
        <el-form-item label="通话记录前十联系人">
          <el-popover
            ...
            <div>短信内容： 【悟空分期】【#name#】的【#年月#】应付金额为【#account#】元，已过期【#day#】天，请转告其尽快进行操作处理。</div>
...
export default {
  ...
  methods: {
    ...
    showFormDialog(id, count, budgetPlanId) {
      this.urgeForm = {
        urge_id: '',
        urge_way: '',
        urge_result: '',
