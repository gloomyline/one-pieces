<template>
  <div>
      ...
      <el-col :span="24">
        <el-form :inline="true">
          ...
          <el-form-item label="计划还款时间">
            <el-date-picker v-model="form.dateRange" type="daterange" align="right" :disabled="flag"></el-date-picker>
          </el-form-item>
          <el-form-item>
    ...
    <el-table :data="tableData" stripe border style="width: 100%;">
	  ...
	  <el-table-column property="encoding" label="借款编号" align="center" min-width="225"></el-table-column>
	  ...
	  <el-table-column property="product_name" label="商品名称" align="center" min-width="150"></el-table-column>
      ...
      <el-table-column property="period" label="期数(月)" align="center" min-width="90"></el-table-column>
	  ...
	  <el-table-column property="monthly" label="本期应还款金额(元)" align="center" min-width="100"></el-table-column>
	  <el-table-column property="total_repayment_amount" label="本期应还款总额(元)" align="center" min-width="100"></el-table-column>
      <el-table-column label="操作" align="center" width="100">
        <template slot-scope="scope">
          <el-button-group style="">
            <el-button type="primary" size="small"  @click.native="showDialog(scope.row)" v-if="scope.row.urge_id === ''">分配</el-button>
            <el-button type="primary" size="small"  @click.native="showDialog(scope.row)" v-if="scope.row.urge_id !== ''">修改分配</el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
    ...
    <div>
      <el-dialog :visible.sync="dialogFormVisible">
        <el-form :model="formData" ref="dialogForm" label-width="120px">
          <el-form-item  label="选择催收员" prop="staff" :rules="{ required: true, message: '催收员不能为空' }">
...
export default {
  ...
  methods: {
    ...
    showDialog(row) {
      this.formData.loan_id = row.loan_id;
      this.formData.budget_plan_id = row.id;
      if (row.admin_id === '') {
        this.formData.staff = '';
      } else {
        this.formData.staff = row.admin_id;
      }
    ...
    handleAssign() {
      const params = {
        ...
        budget_plan_id: this.formData.budget_plan_id,
      };
