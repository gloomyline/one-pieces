        ...
        <el-dialog title="编辑" :visible.sync="dialogFormVisible">
            <el-form :model="dialogForm" ref="dialogForm" label-width="120px" label-position="left">
                ...
                <el-form-item label="起始分值" required>
                    <el-input-number v-model="dialogForm.start" :min="0" :controls="false"></el-input-number>
                </el-form-item>
                <el-form-item label="结束分值" required>
                    <el-input-number v-model="dialogForm.end" :min="0" :controls="false"></el-input-number>
                </el-form-item>
            </el-form>
