<template>
      ...
      <el-row class='backStyle auditContent'>
        ...
        <el-form :model="auditForm" ref="auditForm" label-width="120px">
          <el-form-item label="电审结果" required>
               <el-radio-group v-model="form.tel_result">
                <el-radio :label="1">通过</el-radio>
                <el-radio :label="2">不通过</el-radio>
              </el-radio-group>
          </el-form-item>
          
          <el-form-item label="电审意见" required>
            <el-input type="textarea"  :rows="2" placeholder="请输入意见内容" v-model="form.tel_opinion" style="width:400px;"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="handleSubmit('checks')">提交</el-button>
