...
export default {
  ...
  data() {
    return {
      ...
      currentPage: 1,
      pageSize: 20,
      types: [{ id: 'auth_code', name: '短信验证码' }, { id: 'loan', name: '放款通知' }, { id: 'repayment', name: '还款通知' }, { id: 'overdue', name: '逾期通知' }, { id: 'repay_succ', name: '还款成功' }, { id: 'withdraw', name: '提现通知' }, { id: 'overdue_mass', name: '逾期群发短信' }, { id: 'shop_confirm', name: '商家确认提醒' }],
