	...
	<div>
        <el-form :model="form" ref="articleForm" label-width="120px">
          <el-form-item label="标题" prop="title" :rules="{ required: true, message: '标题不能为空'}">
            <el-input auto-complete="off" v-model="form.title" placeholder="请输入文章的标题" style="width:200px;"></el-input>
          </el-form-item>
          <el-form-item label="文章分类" prop="type" :rules="{ required: true, message: '文章分类不能为空'}">
          ...
          <el-form-item label="排序" prop="sort" :rules="{ required: true, message: '排序不能为空' }">
            <el-input auto-complete="off" v-model="form.sort" placeholder="" style="width:200px;"></el-input>
          </el-form-item>
