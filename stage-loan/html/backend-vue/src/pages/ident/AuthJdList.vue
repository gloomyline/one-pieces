    ...
    <el-table :data="tableData" stripe border style="width: 100%;">
      ...
      <el-table-column label="操作" align="center" >
        <template slot-scope="scope">
          <el-button-group>
            <el-button type="primary" size="small"  @click.native="handleJdInfoShow(scope.row.id)" v-if="scope.row.has_report === 1">查看</el-button>
            <el-button type="danger" size="small"  @click.native="delJDAuth(scope.row.id)">删除</el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    getData() {
      ...
      this.$http.get(`${apiBase}auth-jd`, { params })
