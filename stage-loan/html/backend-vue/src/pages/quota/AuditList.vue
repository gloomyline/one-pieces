<template>
  <div>
    ...
    <div>
      <el-dialog :visible.sync="dialogFormVisible" title='额度审核'>
        <el-form :model="dialogForm" ref="dialogForm" label-width="120px" label-position="left">
          ...
          <el-form-item label="通过金额" required>
            <el-input type="number" :min="0" :max="Math.abs(dialogForm.applyQuota)+1000" :step="100" v-model="dialogForm.allowQuota" style="width: 220px">
    ...
    <div>
      <el-dialog :visible.sync="dialogFormUserVisible" :title='dialogForm.title'>
        <el-form :model="dialogForm" ref="dialogForm" label-width="120px" label-position="left">
          ...
          <el-form-item label="通过金额" required>
            <el-input-number  :min="0" :max="20000" :step="500" v-model="dialogForm.allowQuota" style="width: 220px"></el-input-number>
          </el-form-item>
          <el-form-item label="审核状态"  required>
            <el-radio-group v-model="dialogForm.state">
              <el-radio :label="1">通过</el-radio>
