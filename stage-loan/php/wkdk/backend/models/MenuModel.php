        ...
        return [
            ...
            '借款管理' => [
                ...
                'children' => [
                    ...
                    'backend_menus_loan_grant' => [
                        'title' => '放款管理',
                        'route' => '/vue-dist/#/grant',
                        'children' => []
                    ],
            ...
            '商户额度管理' => [
                'icon' => 'fa-cubes',
                'children' => [
                    'backend_menus_quota_shop_list' => [
                        'title' => '商户额度列表',
                        'route' => '/vue-dist/#/shop-quota-list',
                        'children' => []
                    ],
                    'backend_menus_quota_shop_apply' => [
                        'title' => '商户额度审核列表',
                        'route' => '/vue-dist/#/shop-quota-audit-list',
                        'children' => []
                    ],
                    'backend_menus_quota_shop_log' => [
                        'title' => '商户额度记录',
                        'route' => '/vue-dist/#/shop-quota-log-list',
                        'children' => []
                    ],
                ]
            ],
            '认证管理' => [
                ...
                'children' => [
                    ...
                    'backend_menus_ident_house_fund' => [
                        'title' => '公积金认证',
                        'route' => '/vue-dist/#/auth-house-fund',
                        'children' => [],
                    ],
                    'backend_menus_ident_social_security' => [
                        'title' => '社保认证',
                        'route' => '/vue-dist/#/auth-social-security',
                        'children' => [],
                    ],
                    'backend_menus_ident_credit' => [
                        'title' => '央行征信认证',
                        'route' => '/vue-dist/#/auth-credit',
                        'children' => [],
                    ],
            ...
            '商户申请管理' => [
                ...
                'children' => [
                    'backend_menus_shop_list' => [
                        'title' => '商户列表',
                        'route' => '/vue-dist/#/shop',
                        'children' => []
                    ],
                    'backend_menus_shop_settled' => [
                        'title' => '商户入驻',
                        'route' => '/vue-dist/#/shop-settled',
                        'children' => []
                    ],
                ]
            ],
            '分类管理' => [
                'icon' => 'fa-list-ul',
                'children' => [
                    'backend_menus_category_shop' => [
                        'title' => '商户分类',
                        'route' => '/vue-dist/#/category-shop',
                        'children' => []
                    ],
                    'backend_menus_category_pro' => [
                        'title' => '商品分类',
                        'route' => '/vue-dist/#/category-pro',
                        'children' => []
                    ],
                ]
            ],
