 ...
 * @property double $fronzen_quota 冻结额度
 ...
 * @property integer $is_credit_auth 央行征信认证 0:未填写/未认证 1：已认证
 * @property integer $is_housefund_auth 公积金认证 0:未填写/未认证 1：已认证
 * @property integer $is_socialsecurity_auth 社保认证 0:未填写/未认证 1：已认证
...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['state', 'success_count', 'total_quota', 'gender', 'age'], 'integer'],
            [['fronzen_quota', 'available_quota'], 'double'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_credit_auth' => 'Is Credit Auth',
            'is_housefund_auth' => 'Is Housefund Auth',
            'is_socialsecurity_auth' => 'Is SocialSecurity Auth',
