...
class LimuService
{
    ...
    const API_BIZ_HOUSE_FUND= 'housefund'; // 公积金
    const API_BIZ_SOCIAL_SECURITY= 'socialsecurity'; // 社保
    const API_BIZ_CREDIT= 'credit'; // 央行征信
...
//            '01040000' => [ 'bank_name' => '花旗银行', 'bank_abbreviation' => 'CITIBANK'],
    ...
    // 公积金地区列表查询
    public static function queryHouseFundAreas()
    {
        //公积金地区列表查询参数
        $params = array(
            'method' => 'api.housefund.getareas',
            'apiKey' => self::API_KEY,
            'version' => self::API_VERSION,
        );
        //公积金地区列表查询
    ...
    // 公积金地区登录元素查询
    public static function queryHouseFundLoginElements($areaCode)
    {
        //公积金地区登录元素查询参数
        $params = array(
            'method' => 'api.housefund.getloginelements',
            'apiKey' => self::API_KEY,
            'version' => self::API_VERSION,
            'areaCode' => $areaCode,
        );
    ...
    // 公积金查询
    public static function queryHouseFund($mobile, $username, $password, $area)
    {
        $callBackUrl = Yii::$app->params['limu_callback_url'];
        //公积金查询参数
        $params = array(
    ...
    // 社保地区列表查询
    public static function querySocialSecurityAreas()
    {
        //社保地区列表查询参数
        $params = array(
            'method' => 'api.socialsecurity.getareas',
            'apiKey' => self::API_KEY,
            'version' => self::API_VERSION,
        );
        //社保地区列表查询
    ...
    // 社保地区登录元素查询
    public static function querySocialSecurityLoginElements($areaCode)
    {
        //社保地区登录元素查询参数
        $params = array(
            'method' => 'api.socialsecurity.getloginelements',
            'apiKey' => self::API_KEY,
            'version' => self::API_VERSION,
            'areaCode' => $areaCode,
        );
    ...
    // 社保查询
    public static function querySocialSecurity($mobile, $username, $password, $area)
    {
        $callBackUrl = Yii::$app->params['limu_callback_url'];
        //社保查询参数
        $params = array(
    ...
    // 央行征信查询
    public static function queryCredit($mobile, $username, $password, $middleAuthCode)
    {
        $callBackUrl = Yii::$app->params['limu_callback_url'];
        //央行征信查询参数
        $params = array(
            ...
            'username' => $username, // 用户帐号
            'password' => base64_encode($password), // 密码
            'middleAuthCode' => $middleAuthCode, // 央行征信身份验证码
        );
        //央行征信查询
        ksort($params);
        $request = self::buildRequest($params);
