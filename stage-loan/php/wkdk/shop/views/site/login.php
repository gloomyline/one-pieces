...
<body>
       <!-- 背景 -->
        <div id="login_bg"><img src="<?=Yii::$app->params['img_url']?>images/admin_img/login_bg1.jpg" width="1920" height="1080" alt="背景" /></div>
        <!--登陆 -->
     <div id="lay"> 
        <div id="login_box">
                ...
                <div class="b">
                    ...
                    <div class="psw"><?= $form->field($model, 'password')->passwordInput(['id'=>'psw','value'=>'********']) ?></div>
                        <div class="verifyCode"><?= $form->field($model, 'verifyCode')->textInput(['id'=>'verifyCode','value'=>'请输入验证码']) ?>
                            <?= $form->field($model, 'captcha')
                                ->widget(Captcha::className(),[   
                                   'template' => "{image}",
                                   'imageOptions' => ['title'=>'点击换图', 'alt' => '验证码', 'style' => 'cursor:pointer'],
                            ]); ?>
                        </div>
