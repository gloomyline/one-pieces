<template>
  <div>
    ...
    <el-table :data="tableData" stripe border style="width: 100%;">
      ...
      <el-table-column property="trial_rate" label="信审费率" align="center" min-width="70"></el-table-column>
      <el-table-column property="service_rate" label="服务费率" align="center" min-width="70"></el-table-column>
      <el-table-column property="poundage" label="手续费率" align="center" min-width="70"></el-table-column>
      <el-table-column property="state" label="借款状态" min-width="100" :formatter="stateFormatter" align="center"></el-table-column>
      <el-table-column property="preliminary_officer" label="初审人员" align="center" min-width="130"></el-table-column>
