...
import CashCouponList from './pages/coupon/CashCouponList';
import ManualAssignForm from './pages/coupon/ManualAssignForm';
import CouponUseLogList from './pages/coupon/CouponUseLogList';
...
const router = new Router({
  routes: [
    ...
    {
      path: '/coupon-assign',
      component: ManualAssignForm,
      meta: { title: '手动派发' },
    },
    {
      path: '/coupon-log',
      component: CouponUseLogList,
      meta: { title: '使用记录列表' },
    },
    {
      path: '/confirm-list',
