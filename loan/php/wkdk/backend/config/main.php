    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                #获取前十通话
                [
                    'pattern' => 'call-records/<loan_id:\d+>',
                ...
                [
                    'pattern' => 'coupon',
                    'route' => 'cash-coupon/coupon',
                    'verb' => 'GET'
                ],
                #添加代金券
                [
                    'pattern' => 'add-cash-coupon',
                    'route' => 'cash-coupon/add-cash-coupon',
                    'verb' => 'POST'
                ],
                #删除代金券
                [
                    'pattern' => 'del-coupon',
                    'route' => 'cash-coupon/coupon-del',
                    'verb' => 'POST'
                ],
                #获取代金券信息
                [
                    'pattern' => 'get-coupon/<id:\d+>',
                    'route' => 'cash-coupon/get-coupon',
                    'verb' => 'GET'
                ],
                #编辑代金券
                [
                    'pattern' => 'update-coupon',
                    'route' => 'cash-coupon/update-coupon',
                    'verb' => 'PUT'
                ],
                #手动派发代金券
                [
                    'pattern' => 'manual-assign-coupon',
                    'route' => 'cash-coupon/manual-assign',
                    'verb' => 'POST'
                ],
                #获得抵扣券列表
                [
                    'pattern' => 'get-repayment-coupon',
                    'route' => 'cash-coupon/get-repayment-coupon',
                    'verb' => 'GET'
                ],
                #代金券使用记录
                [
                    'pattern' => 'coupon-log',
                    'route' => 'cash-coupon/coupon-use-log',
                    'verb' => 'GET',
                ],
                #### 支付管理 #########################
                #借款确认列表
