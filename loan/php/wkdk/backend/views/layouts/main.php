                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu" style="background: none;">
                        <a class="dropdown-toggle">
                            <img src="http://local-admin.wkdk.com/images/profile_small.jpg" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="http://local-admin.wkdk.com/images/profile_small.jpg" class="img-circle" alt="User Image">
                </div>
